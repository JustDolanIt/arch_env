...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1c", "2b", "3b", "4c", "5c", "6c", "7c", "8c", "9m" }, s, awful.layout.layouts[1])
    ...
    battery_widgettimer = timer({ timeout = 5 })
    battery_widgettimer:connect_signal("timeout",
      function()
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            battery_widget,
            spacer,
            wibox.container.rotate(volume_widget, "east"),
            spacer,
            s.mylayoutbox,
        },
    }
...
-- Disabling toolbar to save space
